...
int nAnonymizeBithereumAmount = 1000;
...
{
    boost::filesystem::path pathConfigFile(GetArg("-conf", "bithereum.conf"));
...
{
    boost::filesystem::path pathPidFile(GetArg("-pid", "bithereumd.pid"));
