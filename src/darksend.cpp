    ...
    if(fMasterNode) {
        ...
        BOOST_FOREACH(const CTransaction& txCollateral, vecSessionCollateral) {
            ...
            /*
                ...
                allow endless transaction that would bloat Bithereum and make it unusable. To
...
bool CDarksendPool::DoAutomaticDenominating(bool fDryRun)
{
    ...
    CAmount nBalanceNeedsAnonymized = nAnonymizeBithereumAmount*COIN - pwalletMain->GetAnonymizedBalance();
...
void ThreadCheckDarkSendPool()
{
    ...
    RenameThread("bithereum-darksend");
