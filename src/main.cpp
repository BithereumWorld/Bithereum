...
if(nHeight < MONTHLY_BLOCKCOUNT * 1)
    {
        nSubsidy = 0.2 * COIN;
    }
else if(nHeight <  MONTHLY_BLOCKCOUNT * 2)
    {
        nSubsidy = 0.4 * COIN;
    }
else if(nHeight <  MONTHLY_BLOCKCOUNT * 3)
    {
        nSubsidy = 0.8 * COIN;
    }
...
else if(nHeight <  MONTHLY_BLOCKCOUNT * 5)
    {
        nSubsidy = 1.2 * COIN;
    }
	...
	else if(nHeight <  MONTHLY_BLOCKCOUNT * 7)
    {
        nSubsidy = 10 * COIN;
    }
...
{
    RenameThread("bithereum-loadblk");
