...
QT_MOC_LITERAL(8, 131, 31) // "AnonymizeBithereumAmountChanged"
    ...
    "AnonymizeBithereumAmountChanged"
};
...
void OptionsModel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 5: _t->AnonymizeBithereumAmountChanged((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            using _t = void (OptionsModel::*)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&OptionsModel::darksendRoundsChanged)) {
                *result = 4;
                return;
            }
        }
        {
            using _t = void (OptionsModel::*)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&OptionsModel::AnonymizeBithereumAmountChanged)) {
                *result = 5;
                return;
            }
        }
...
// SIGNAL 5
void OptionsModel::AnonymizeBithereumAmountChanged(int _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
