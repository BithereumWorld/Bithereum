...
public:
    ...
    {
        AdrenalineNodeConfigDialog->setWindowTitle(QApplication::translate("AdrenalineNodeConfigDialog", "Master Node Configuration Template", nullptr));
#ifndef QT_NO_TOOLTIP
        detailText->setToolTip(QApplication::translate("AdrenalineNodeConfigDialog", "<html><head/><body><p>This pane shows an example bithereum.conf template with the necessary masternode settings.</p></body></html>", nullptr));
#endif // QT_NO_TOOLTIP
    } // retranslateUi
