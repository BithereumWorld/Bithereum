...
public:
    ...
    void setupUi(QDialog *CoinControlDialog)
    {
        ...
        labelCoinControlAmount->setText(QStringLiteral("0.00 BTH"));
        ...
        labelCoinControlFee->setText(QStringLiteral("0.00 BTH"));
        ...
        labelCoinControlAfterFee->setText(QStringLiteral("0.00 BTH"));
        ...
        labelCoinControlChange->setText(QStringLiteral("0.00 BTH"));
    ...
    void retranslateUi(QDialog *CoinControlDialog)
    {
        ...
        ___qtreewidgetitem->setText(4, QApplication::translate("CoinControlDialog", "Darksend Rounds", nullptr));
